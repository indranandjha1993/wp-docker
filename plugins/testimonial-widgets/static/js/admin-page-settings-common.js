...
jQuery(document).ready(function() {
    ...
    jQuery("#ti-order-id, #ti-display-type-id, #ti-text-align-id, #ti-arrow-id, #ti-dateformat-id, #ti-navigation-id, #ti-widget-options input[type=checkbox]:not(.no-form-update), #ti-box, #ti-font, #ti-slider-interval, #ti-review-lines")
    .on("change", function() {
