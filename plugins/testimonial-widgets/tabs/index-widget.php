...
<span class="delete">
<a class="submitdelete" href="<?php echo 'admin.php?page=' . esc_attr($trustindex_testimonials_pm->get_plugin_slug()) . '/tabs/index-widget.php&delete_widget=' . esc_attr($widget->id); ?>" onclick="if ( confirm('<?php echo TrustindexTestimonialsPlugin::___('Delete') . ' ' . esc_attr($widget->name) . '?'; ?>') ) { return true;} return false;"><?php echo TrustindexTestimonialsPlugin::___('Delete'); ?></a>
</span>
</div>
</td>
