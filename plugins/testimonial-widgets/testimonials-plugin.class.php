...
$style .= ".ti-widget.ti-wp-testimonial-" . $id . " .ti-widget-container .ti-review-item .ti-profile-details .ti-date a {text-decoration: none !important;} ";
$style .= ".ti-widget.ti-wp-testimonial-" . $id . " .ti-widget-container .ti-review-item .ti-profile-details .ti-date a:hover{text-decoration: underline !important;} ";
...
$dbtable = $this->get_widget_tablename();
global $wpdb;
$result = $wpdb->get_row("SELECT * FROM $dbtable WHERE id={$id}");
return $result;
}
...
$dbtable = $this->get_widget_tablename();
global $wpdb;
$row = $wpdb->get_row("SELECT * FROM $dbtable WHERE id=$id");
